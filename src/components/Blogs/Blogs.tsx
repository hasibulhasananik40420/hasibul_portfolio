    ...
    <div className="bg-white" id="blog">
        <div className="max-w-7xl mx-auto md:py-[100px] py-16 px-3 md:px-6 lg:px-2">
            <div className="md:flex justify-between items-center">
                <div>
                    <p className="text-[#5B77F5] md:text-[20px] text-[16px] font-normal uppercase">Our Blog</p>
                     <h1 className="md:text-[46px] text-[32px] font-bold text-black">Our Latest Blog</h1>
                </div>
